...
io.on('connection',function (dat) {
  ...
  connection.query(sql, [1,2,3,4,5,6,7,8], function(error, results, fields) {
      ...
      //
      // var numbers9=[];
      // numbers9.push(results[8][param]);

      results21=results[8][param];
      results22=results[9][param];
      results23=results[10][param];
      results24=results[11][param];
      results25=results[12][param];
      results26=results[13][param];
      results27=results[14][param];
      results28=results[15][param];

      numbers9=[];
      numbers9.push(results21);
      numbers9.push(results22);
      numbers9.push(results23);
      numbers9.push(results24);
      numbers9.push(results25);
      numbers9.push(results26);
      numbers9.push(results27);
      numbers9.push(results28);
      ...
      var objs1=JSON.stringify(obj1);

      // console.log(objs);
      // console.log(objs1);
      if(dat.handshake.query['foo1']=="bar1"){
      console.log(dat.handshake.query['foo1']);
      io.sockets.emit('temp', objs);
      }else if(dat.handshake.query['foo1']=="bar2"){
      console.log(dat.handshake.query['foo1']);
      io.sockets.emit('temp1', objs1);
      }
      // io.sockets.emit('temp1', objs);
    });
